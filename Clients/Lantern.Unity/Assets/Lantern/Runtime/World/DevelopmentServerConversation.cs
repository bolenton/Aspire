    ...
    public sealed class DevelopmentServerConversation : MonoBehaviour
    {
        public async void Run(AdventureController adventure, CompanionConnection server, CompanionVoice voice)
        {
            ...
            try
            {
                ...
                await adventure.AskAsync("Ember, tell me why this adventure matters to you.");
                ...
                Debug.Log("Lantern server check: PASS; authenticated Unity connection, world-grounded reply, streamed Piper playback completed and cancellation held. Physical microphone conversation remains a separate check.");
            }
